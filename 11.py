...
a.append([24, 47, 32, 60, 99, 03, 45, 2, 44, 75, 33, 53, 78, 36, 84, 20, 35, 17, 12, 50])
...
for count in range(len(a)):
    for count2 in range(len(a[count])-3):
        ...
        if temph > prod:
            prod = temph
        tempv = a[count2][count]*a[count2+1][count]*a[count2+2][count]*a[count2+3][count]
        if tempv > prod:
            prod = tempv
for count in range(17):
    for count2 in range(17):
        tempd1 = a[count][count2]*a[count+1][count2+1]*a[count+2][count+2]*a[count+3][count2+3]
        if tempd1 > prod:
            prod = tempd1
        tempd2 = a[19-count][19-count2]*a[18-count][18-count2]*a[17-count][17-count2]*a[16-count][16-count2]
        if tempd2 > prod:
            prod = tempd2
print prod